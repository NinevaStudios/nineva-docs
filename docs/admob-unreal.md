...
**Note:** Please refer to AdMob guides to fill in all the necessary information in your account. When you receive an email that your account is approved and see this banner on your home page you are all set up to use real ads in your application.
...
**Note:** During development you can use special Google provided test ad unit IDs. Please refer to [this](#setting-up-test-ads) page for more information.
...
### Test Devices
You can use real ad units and click ads on test devices. These ads will have a "Test Ad" label and are safe to click on (**Warning:** do not click ads that don't have the "Test Ad" label during development as your AdMob account might be flagged and suspended for fraud).
